...
const Projects = () => {
  ...
  return (
    <Box id="projects" sx={{ py: 12, bgcolor: '#FFFFFF', boxShadow: 'inset 0 4px 30px rgba(0, 0, 0, 0.1)' }}>
      <Container>
        <Typography
          variant="h2"
          component="h2"
            ...
            >
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', width: { xs: '100%', md: '50%' } }}>
                <CardContent sx={{ flexGrow: 1, p: 4 }}>
                  <Typography gutterBottom variant="h4" component="h3" sx={{ fontWeight: 'bold', mb: 2, color: '#212121' }}>
                    {project.title}
                  </Typography>
                  <Typography variant="body1" sx={{ color: '#212121', opacity: 0.8 }} paragraph>
                    {project.description}
                  </Typography>
                  {project.features && (
                    <>
                      <Typography variant="h6" sx={{ fontWeight: 'bold', mt: 3, mb: 2, color: '#212121' }}>
                        Xüsusiyyətlər:
                      </Typography>
                      <Box component="ul" sx={{ pl: 2 }}>
                        {project.features.map((feature, idx) => (
                          <Typography key={idx} component="li" variant="body1" sx={{ color: '#212121', opacity: 0.8, mb: 1 }}>
                            {feature}
                          </Typography>
                        ))}
                      </Box>
